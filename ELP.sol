...
contract ELP is ERC20 
{
    ...
    {
        require(msg.sender == ownerAndDistributor, "Error - ELP.sol - Modifier:onlyDistributor - onlyCDistributor function");
        _;
    }
    ...
    function burn(uint256 value) onlyDistributor public
    {
